...
public class DisplayPartRecipe implements IDisplayPartBuilderRecipe {
   ...
   * @apiNote  Null for a recipe generated by {@link slimeknights.mantle.recipe.IMultiRecipe}: 1.21 moved a recipe's ID
   *           onto {@link net.minecraft.world.item.crafting.RecipeHolder}, which a multi recipe cannot reach from
   *           inside itself.
   */
  @Nullable
