...
public interface HarvestEnchantmentsModifierHook {
   ...
   * @return  Old enchantment component if enchants were applied
   */
  @Nullable
  static ItemEnchantments updateHarvestEnchantments(IToolStackView tool, ItemStack stack, ToolHarvestContext context) {
    ...
    if (player == null || !player.isCreative()) {
          ...
          for (ModifierEntry entry : armor.getModifierList()) {
            ...
            if (hook != null) {
              ...
              if (enchantments == null) {
                ...
                enchantments = EnchantmentLevels.copyOf(originalEnchants);
              }
      ...
      if (enchantments != null) {
        ...
        stack.set(DataComponents.ENCHANTMENTS, enchantments.toComponent());
   ...
   * @param originalEnchants  Original enchantment component. If empty, removes the component instead of writing an empty one, as the two are
   *                          different stacks for the purposes of {@link ItemStack#isSameItemSameComponents(ItemStack, ItemStack)}.
   */
