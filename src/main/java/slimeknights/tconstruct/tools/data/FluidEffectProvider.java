...
public class FluidEffectProvider extends AbstractFluidEffectProvider {
  ...
  protected void addFluids() {
    ...
    // ender - teleporting
    LivingEntityPredicate hasReturning = new HasMobEffectPredicate(TinkerEffects.returning);
    ...
    addGem(TinkerFluids.moltenEmerald ).addBlockEffect(new HarvestTierPredicate(Tiers.IRON),      new BreakBlockFluidEffect(10, DatagenEnchantments.holder(Enchantments.SILK_TOUCH), 1));
    addGem(TinkerFluids.moltenDiamond ).addBlockEffect(new HarvestTierPredicate(Tiers.DIAMOND),   new BreakBlockFluidEffect(10, DatagenEnchantments.holder(Enchantments.FORTUNE), 3));
