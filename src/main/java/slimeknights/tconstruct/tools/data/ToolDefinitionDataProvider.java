...
public class ToolDefinitionDataProvider extends AbstractToolDefinitionDataProvider {
  ...
  protected void addToolDefinitions() {
    ...
    define(ToolDefinitions.PICKAXE)
      ...
      // harvest
      .module(ToolActionsModule.of(TinkerToolActions.PICKAXE_DIG))
    ...
    define(ToolDefinitions.MATTOCK)
      ...
      // harvest
      .module(ToolActionsModule.of(TinkerToolActions.AXE_DIG, TinkerToolActions.SHOVEL_DIG))
    ...
    define(ToolDefinitions.EXCAVATOR)
      ...
      // harvest
      .module(ToolActionsModule.of(TinkerToolActions.SHOVEL_DIG))
    ...
    define(ToolDefinitions.HAND_AXE)
      ...
      // harvest
      .module(ToolActionsModule.of(TinkerToolActions.AXE_DIG, TinkerToolActions.SHIELD_DISABLE))
    ...
    define(ToolDefinitions.KAMA)
      ...
      // harvest
      .module(ToolActionsModule.of(TinkerToolActions.HOE_DIG))
    ...
    define(ToolDefinitions.DAGGER)
      ...
      // behavior
      .module(ToolActionsModule.of(TinkerToolActions.SWORD_DIG, TinkerToolActions.HOE_DIG))
