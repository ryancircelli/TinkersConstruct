...
public class MaterialItemFixture {
  ...
  public static void init() {
    ...
    BuiltInRegistries.ITEM.register(ResourceLocation.fromNamespaceAndPath("test", "test_material"), MATERIAL_ITEM);
    BuiltInRegistries.ITEM.register(ResourceLocation.fromNamespaceAndPath("test", "test_material_2"), MATERIAL_ITEM_2);
    BuiltInRegistries.ITEM.register(ResourceLocation.fromNamespaceAndPath("test", "test_head"), MATERIAL_ITEM_HEAD);
    BuiltInRegistries.ITEM.register(ResourceLocation.fromNamespaceAndPath("test", "test_handle"), MATERIAL_ITEM_HANDLE);
    BuiltInRegistries.ITEM.register(ResourceLocation.fromNamespaceAndPath("test", "test_extra"), MATERIAL_ITEM_EXTRA);
  }
}
